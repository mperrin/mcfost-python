...
project = u'MCFOST Python tools'
copyright = u'2011-2013, Marshall Perrin & Christophe Pinte '
...
latex_documents = [
  ('index', 'mcfost_python.tex', u'MCFOST Python',
   u'Marshall Perrin & Christophe Pinte', 'manual'),
]
