...
class ModelResults(object):
    ...
    def plot_image(self, wavelength0, overplot=False, inclination=None, cmap=None, ax=None, 
        ...
        * Add coronagraphic occulters
        ...
        inclin_index = find_closest(self.parameters.inclinations, inclination)
        ...
        # Display the image!
        ax = imshow_with_mouseover(ax, image,  norm=norm, cmap=cmap, extent=extent)
...
class Observations(object):
    ...
    def _check_and_load_SED(self):
        if self._sed_table is None:
            self._sed_table = ascii.read('/Users/mperrin/data/mcfost/models_esoha569/data/observed_sed.txt', Reader=ascii.NoHeader, names=['wavelength','flux','uncertainty','source'])


    @property
    def sed_data(self):
        self._check_and_load_SED()
    ...
    def plot_SED(self, title=None, overplot=False, 
             alpha=0.75, **kwargs):
        """ Plot observed SED
